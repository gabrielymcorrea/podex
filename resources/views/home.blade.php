...
<head>
    ...
    <style>
      ...
      .cadastrar:hover , .link_login:hover{
        color: #4723D9;
      }
      h4{
        font-size: 2rem;
      ...
      <div class="row">
        ...
        <div class="row" style="margin-top: 70px;">
          <div class="col-6 sobre" >
            ...
            <p> Três colegas em busca da realização do tcc. A meta é se livrar dessa merda de rolê(faculdade) que ta chatão já kkkk(cada K uma lagrima), embarque nessa aventura com a gente? <a href="/register" class="link_login"> bora lá hehe :) </a>
            <div>
